    ...
    messages = [
        ...
        },
        {
            ...
            "content": (
                ...
                "**Answer Format**:\n\n"
                "1. **Answer**  \n"
                "- If you are specifically asked to perform an action, do it as part of your response. (i.e. create a document/artifact/material, summarize/research/analyze) \n"
                "- Output your response in a clear, human-readable way.  \n"
